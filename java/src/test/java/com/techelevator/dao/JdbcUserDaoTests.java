...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "first", "last", "user1", "ROLE_USER");
    protected static final User USER_2 = new User(2, "user2", "first", "last", "user2", "ROLE_USER");
    private static final User USER_3 = new User(3, "user3", "first", "last", "user3", "ROLE_USER");
